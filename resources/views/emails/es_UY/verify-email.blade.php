                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; max-width: 600px;">
                    ...
                    <tr>
                        <td align="center" bgcolor="#2563eb" style="padding: 40px 30px; color: #ffffff;">
                            <h1 style="margin: 0; font-size: 28px; font-weight: bold; color: #ffffff;">Verificar Dirección de Correo</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 15px 0; font-size: 16px; line-height: 24px; color: #333333;">Por favor, haz clic en el botón de abajo para verificar tu dirección de correo electrónico.</p>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center" bgcolor="#2563eb" style="border-radius: 4px;">
                                                    <a href="{{ $url }}" target="_blank" style="font-size: 16px; font-weight: bold; color: #ffffff; text-decoration: none; padding: 14px 40px; display: inline-block;">Verificar Correo Electrónico</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
