...
<head>
    ...
    <title>Invitación de Administrador</title>
</head>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; max-width: 600px;">
                    ...
                    <tr>
                        <td align="center" bgcolor="#7c3aed" style="padding: 40px 30px; color: #ffffff;">
                            <h1 style="margin: 0; font-size: 28px; font-weight: bold; color: #ffffff;">Acceso de Administrador</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            <p style="margin: 0 0 15px 0; font-size: 16px; line-height: 24px; color: #333333;">Hola {{ $admin->firstname ?? '' }},</p>

                            <p style="margin: 0 0 15px 0; font-size: 16px; line-height: 24px; color: #333333;">
                                Te dieron acceso de administrador a MTAV.
                            </p>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px 0;">
                                <tr>
                                    <td bgcolor="#f3f4f6" style="padding: 20px; border: 1px solid #e5e7eb;">
                                        <p style="margin: 0 0 10px 0; font-size: 16px; font-weight: bold; color: #333333;">Tus responsabilidades</p>
                                        <p style="margin: 0 0 15px 0; font-size: 14px; line-height: 22px; color: #333333;">Como administrador, vas a poder gestionar miembros, familias, unidades y otros aspectos del/los proyecto(s) de vivienda.</p>

                                        @if($projects && $projects->count() > 0)
                                        <p style="margin: 0 0 8px 0; font-size: 14px; font-weight: bold; color: #333333;">Vas a gestionar:</p>
                    ...
                    <tr>
                        <td bgcolor="#f9fafb" style="padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                            ...
                            <p style="margin: 0; font-size: 13px; line-height: 20px; color: #6b7280;">Si no esperabas esta invitación, por favor contacta a tu administrador del sistema.</p>
                        </td>
                    </tr>
                </table>
            </td>
