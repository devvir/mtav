...
const maxWidthClass = computed(() =>
  props.wide ? 'max-w-md sm:max-w-lg md:max-w-2xl lg:max-w-5xl' : 'max-w-md sm:max-w-lg',
);
</script>

<template>
  <div
    class="flex min-h-svh flex-col items-center justify-center gap-4 bg-background p-4 md:gap-6 md:p-10"
  >
