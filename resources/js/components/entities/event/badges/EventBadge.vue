...
const badgeClass = computed(() => {
  ...
  const variantStyles: Record<string, string> = {
    ...
    'lottery': 'bg-amber-100 text-amber-950 border border-amber-300 dark:bg-amber-900/30 dark:text-amber-50 dark:border-amber-600/50', // Slightly more prominent border
    'online': 'bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-100',
    'onsite': 'bg-sky-100 text-sky-800 border border-sky-300 dark:bg-sky-900/40 dark:text-sky-100 dark:border-sky-600/50', // Slightly more prominent border
    ...
    'no-date': 'bg-gray-50/80 text-gray-400 border border-dashed border-gray-400 dark:bg-gray-900/15 dark:text-gray-500 dark:border-gray-600 opacity-60', // Prominent border for size perception
  };
