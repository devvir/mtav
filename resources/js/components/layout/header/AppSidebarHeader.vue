...
<template>
  <header class="@container/header m-0 mb-base @md:px-base">
    <div
      class="relative flex items-center justify-between gap-base border-t border-r border-border bg-linear-to-r from-sidebar/70 to-background to-70% px-8 py-4 shadow-lg shadow-foreground/10 transition-[width,height] ease-linear @md:mt-4 @md:mb-wide @md:rounded-lg @md:px-wide @md:py-3 z-20"
    >
