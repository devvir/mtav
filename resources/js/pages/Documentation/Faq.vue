...
<template>
    ...
    <div class="mx-auto max-w-4xl px-4 py-8 md:px-6 md:py-12">
        ...
        <div class="space-y-3">
            <div v-for="(faq, index) in questions" :key="index"
                ...
                <button @click="toggleItem(index)"
                    ...
                    <svg :class="{ 'rotate-180': openItems.has(index) }"
                ...
                <div v-show="openItems.has(index)"
        ...
        <div class="mt-12 rounded-lg bg-gray-50 p-6 dark:bg-gray-800">
            <p class="text-base text-gray-700 dark:text-gray-300">
                ...
                {{ _(' You can contact an admin by going to Dashboard > Admins > click on an admin > Click Contact.') }}
            </p>
        </div>
    </div>
