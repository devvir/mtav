...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./data/Development/Repos/MTAV/mtav/public/storage' => 'string',
...
'api.version','app.name','app.env','app.debug','app.url',
...
'auth.superadmins','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key','broadcasting.connections.reverb.secret',
...
'filesystems.disks.s3.report','filesystems.links./data/Development/Repos/MTAV/mtav/public/storage','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist',
...
'debugbar.queries.explain','sanctum.csrf-cookie','projects.store','projects.destroy','admins.index',
'admins.store','admins.show','admins.update','admins.destroy','projects.index',
'projects.update','units.store','units.update','units.destroy','families.store',
'families.update','families.destroy','users.store','users.destroy','projects.show',
'units.index','units.show','families.index','families.show','users.index',
'users.show','logs.index','login',
...
'projects.show','home','gallery','users.index','users.show',
'families.index','families.show','units.index','units.show','logs.index',
'logs.show','profile.edit','profile.update','password.edit',
'password.update','appearance','projects.index','projects.edit','projects.update',
'setCurrentProject','users.create','users.store','users.edit','users.update',
'users.destroy','families.create','families.store','families.destroy','units.create',
'units.store','units.edit','units.update','units.destroy','register','projects.create','projects.store','projects.destroy',
'storage.local',);
...
'SESSION_DOMAIN','FILESYSTEM_DISK','QUEUE_CONNECTION','CACHE_STORE','MEMCACHED_HOST',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','BROADCAST_CONNECTION','REVERB_APP_ID','REVERB_APP_KEY',
'REVERB_APP_SECRET','VITE_APP_NAME',);
